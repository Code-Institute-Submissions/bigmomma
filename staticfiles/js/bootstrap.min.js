/*!
  ...
  */
!function (t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("static/js/popper.min.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "static/js/popper.min.js"], e) : e(t.bootstrap = {}, t.jQuery, t.Popper)
}(this, function (t, e, n) {
    "use strict";
    ...
    var o = function (t) {
                    ...
                    if (!this._element.disabled && !t(this._element).hasClass(f)) {
                        ...
                        if (l._clearMenus(), !i) {
                            ...
                            if (t(e).trigger(r), !r.isDefaultPrevented()) {
                                if (!this._inNavbar) {
                                    if ("undefined" == typeof n) throw new Error("Bootstrap dropdown require Popper.js (https://popper.min.js.org)");
                                    var o = this._element;
        ...
        var e = "tooltip", i = "bs.tooltip", a = "." + i, l = t.fn[e], h = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
            ...
            I = "manual", A = function () {
                function l(t, e) {
                    if ("undefined" == typeof n) throw new Error("Bootstrap tooltips require Popper.js (https://popper.min.js.org)");
